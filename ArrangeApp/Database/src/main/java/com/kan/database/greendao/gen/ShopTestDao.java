...
/** 
 * DAO for table "SHOP_TEST".
*/
public class ShopTestDao extends AbstractDao<ShopTest, Long> {

    public static final String TABLENAME = "SHOP_TEST";

    /**
     * Properties of entity ShopTest.<br/>
    ...
    public ShopTestDao(DaoConfig config) {
        super(config);
    }
    
    public ShopTestDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SHOP_TEST\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"SHOP_TEST\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, ShopTest entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, ShopTest entity) {
        stmt.clearBindings();
    ...
    @Override
    public ShopTest readEntity(Cursor cursor, int offset) {
        ShopTest entity = new ShopTest( //
    ...
    @Override
    public void readEntity(Cursor cursor, ShopTest entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(ShopTest entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(ShopTest entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(ShopTest entity) {

...
import bilibili.app.BangumiIndexActivity;
import bilibili.app.BangumiScheduleActivity;
import bilibili.app.LivePlayerActivity;
import bilibili.app.OriginalRankActivity;
import bilibili.app.VideoDetailsActivity;
...
public class HomeRecommendedSection extends StatelessSection {
    ...
    private int[] icons = new int[]{
            ...
            R.drawable.ic_category_t1, R.drawable.ic_category_t1,
            R.drawable.ic_category_t3, R.drawable.ic_category_t1,
            R.drawable.ic_category_t4, R.drawable.ic_category_t1,
            R.drawable.ic_category_t1, R.drawable.ic_category_t1,
            R.drawable.ic_category_t1, R.drawable.ic_category_t5,
            R.drawable.ic_category_t1, R.drawable.ic_category_t1
    };

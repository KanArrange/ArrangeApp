...
import bilibili.base.AbsRecyclerViewAdapter;
...
public class ActivityCenterRecyclerAdapter extends AbsRecyclerViewAdapter {
    ...
    public ClickableViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ItemViewHolder(LayoutInflater.from(getContext()).inflate(R.layout.item_activity_center, parent, false));
    }
    ...
    public void onBindViewHolder(ClickableViewHolder holder, int position) {
        if (holder instanceof ItemViewHolder) {
            ...
            Glide.with(getContext()).load(activitys.get(position).getCover()).centerCrop().diskCacheStrategy(DiskCacheStrategy.ALL).placeholder(R.drawable.bili_default_image_tv).dontAnimate().into(itemViewHolder.mVideoImg);

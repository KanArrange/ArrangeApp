...
import bilibili.fragment.AttentionPeopleFragment;
import bilibili.fragment.ConsumeHistoryFragment;
import bilibili.fragment.HistoryFragment;
...
public class BiliBiliActivity extends RxBaseActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public int getLayoutId() {
        return R.layout.bili_activity_main;
    }
    ...
    private void initFragments() {
        ...
        fragments = new Fragment[]{mHomePageFragment, mFavoritesFragment, mHistoryFragment, mAttentionPeopleFragment, mConsumeHistoryFragment, mSettingFragment};
        // 添加显示第一个fragment
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.item_download:
                // 离线缓存
                startActivity(new Intent(BiliBiliActivity.this, OffLineDownloadActivity.class));
                return true;
            case R.id.item_vip:
                //大会员
                startActivity(new Intent(BiliBiliActivity.this, VipActivity.class));
                return true;

...
public class RegularPentagonView2 extends View {
    ...
    private static float mRotateDegrees = -36;
    private Path mPath, mPath1;

    public RegularPentagonView2(Context context) {
        this(context, null);
    }

    public RegularPentagonView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RegularPentagonView2(Context context, AttributeSet attrs, int defStyleAttr) {
